...
export const NODE_TYPE_COLORS: Record<string, NodeAccentColors> = {
  ...
  upload_image_node: {
    hex:             "#0ea5e9",
    pulseRgba:       "rgba(14,165,233,0.45)",
    borderColor:     "#0ea5e9",
    activeShadow:    "0 0 16px rgba(14,165,233,0.45)",
    idleBorderColor: "rgba(14,165,233,0.28)",
    idleShadow:      "0 0 10px rgba(14,165,233,0.14)",
  },
  upload_video_node: {
    hex:             "#8b5cf6",
  ...
  image_crop_node: {
    hex:             "#f97316",
    pulseRgba:       "rgba(249,115,22,0.45)",
    borderColor:     "#f97316",
    activeShadow:    "0 0 16px rgba(249,115,22,0.45)",
    idleBorderColor: "rgba(249,115,22,0.28)",
    idleShadow:      "0 0 10px rgba(249,115,22,0.14)",
  },
  extract_frame_node: {
    hex:             "#10b981",
    pulseRgba:       "rgba(16,185,129,0.45)",
    borderColor:     "#10b981",
    activeShadow:    "0 0 16px rgba(16,185,129,0.45)",
    idleBorderColor: "rgba(16,185,129,0.28)",
    idleShadow:      "0 0 10px rgba(16,185,129,0.14)",
  },
};
