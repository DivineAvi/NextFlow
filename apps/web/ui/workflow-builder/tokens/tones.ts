/**
 * Central tone tokens for the workflow builder UI.
 * Field tones = surface controls; accent tones = handles and connection chrome.
 */

// --- Field controls (textarea, text field, toggle, upload) ---
...
// --- Handles (React Flow Handle fill, node handle data-tone) ---

export type AccentTone = "yellow" | "orange" | "blue" | "zinc";

/** Hex fill for programmatic Handle `style` (e.g. handler renderer). */
