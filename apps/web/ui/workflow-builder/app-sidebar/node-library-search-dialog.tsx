...
import { filterSidebarNodes } from "./use-filter-sidebar-nodes";

export type NodeLibrarySearchDialogProps = {
  nodes: SidebarNode[];
  open: boolean;
                    ...
                    >
                      ...
                      >
                        <Icon
                          className={cn(
                            "size-[22px]",
                            isKeyboardActive ? "text-white" : "text-zinc-300"
                          )}
                          strokeWidth={1.75}
                          aria-hidden
                        />
