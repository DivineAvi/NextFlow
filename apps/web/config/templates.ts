...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    nodes: [
      ...
      { id: "n-sys1", type: "text_node", position: { x: 60, y: 380 }, data: { label: "System Prompt A", text: "You are a professional marketing copywriter. Generate a compelling one-paragraph product description based on the provided image.", status: "PENDING" } },
      { id: "n-details", type: "text_node", position: { x: 60, y: 540 }, data: { label: "Product Details", text: "Describe the product shown in the image. Include key features, benefits, and what makes it stand out.", status: "PENDING" } },
      { id: "n-llm1", type: "llm_node", position: { x: 580, y: 220 }, data: { label: "Product Description", model: "gemini-2.0-flash", status: "PENDING" } },
      ...
      { id: "n-llm2", type: "llm_node", position: { x: 900, y: 460 }, data: { label: "Final Marketing Copy", model: "gemini-2.0-flash", status: "PENDING" } },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "n-llm", type: "llm_node", position: { x: 380, y: 280 }, data: { label: "Image Analysis", model: "gemini-2.0-flash", status: "PENDING" } },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "n-llm", type: "llm_node", position: { x: 620, y: 280 }, data: { label: "Caption Generator", model: "gemini-2.0-flash", status: "PENDING" } },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "n-llm", type: "llm_node", position: { x: 620, y: 280 }, data: { label: "Region Analyzer", model: "gemini-2.0-flash", status: "PENDING" } },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "n-llm", type: "llm_node", position: { x: 400, y: 240 }, data: { label: "Text Transformer", model: "gemini-2.0-flash", status: "PENDING" } },
    ],
    edges: [
